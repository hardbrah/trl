...
class PPOTrainer(Trainer):
    ...
    def __init__(
        ...
        if data_collator is None:
            data_collator = AgentDataCollatorWithPadding(self.processing_class)
        ...
        if ref_model:
            ...
            self.is_peft_model
        ):  # if policy is peft model then ref_model will be set None
            self.ref_model = None
        else:  # without peft but ref_model is None
        ...
        self.dataloader = DataLoader(
            ...
            shuffle=True,
            collate_fn=AgentDataCollatorWithPadding(self.processing_class),  # hardcoded
    ...
    def train(self):
        ...
        for update in range(1, args.num_total_batches + 1):
            ...
            with torch.no_grad():
                ...
                trajectory = ["search", True]  # [type, return_new_query]
                ...
                for i in range(
                    ...
                    ref_logprob = selective_log_softmax(
                        ref_logits, response
                    )  # more stable but less efficient for bf16
                ...
                for mini_batch_start in range(
                    ...
                    for micro_batch_start in range(
                        ...
                        with accelerator.accumulate(model):
                            ...
                            loss = pg_loss * pg_coef + args.vf_coef * vf_loss
